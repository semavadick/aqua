...
/**
 * Класс для работы с локализацией категории
 * @ORM\Entity()
...
class CategoryI18n extends I18n {
    ...
    /**
     * @ORM\Id()
     * @ORM\ManyToOne(targetEntity="app\models\Category", inversedBy="i18ns")
    ...
    public function generateSlug() {
        ...
        $this->slug = (new SlugHelper())->generateUniqueSlugForI18n($this, $this->name, $doctrine->getEntityManager()->getRepository('Models:CategoryI18n'));
    }
