 ...
 */
class AdditionProductI18n extends I18n {

    /**
     * @ORM\Id()
     * @ORM\ManyToOne(targetEntity="app\models\AdditionProduct", inversedBy="i18ns")
    ...
    public function generateSlug() {
        ...
        $this->slug = (new SlugHelper())->generateUniqueSlugForI18n($this, $this->name, $doctrine->getEntityManager()->getRepository('Models:AdditionProductI18n'));
    }
