...
class ProductionI18nForm extends I18nForm {
    ...
    public function fillI18n(I18n $i18n, Entity $entity) {
        $i18n->setProductionTitle($this->title);
        $i18n->setProductionText($this->text);
        return true;
    }
    ...
    public function populateFromI18n(I18n $i18n) {
        $this->title = $i18n->getProductionTitle();
        $this->text = $i18n->getProductionText();
    }
