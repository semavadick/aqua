...
class CategoryForm extends EntityForm {
    ...
    protected function fillEntity(Entity $entity) {
        ...
        $relatedCategories = $this->getEntityManager()->getRepository('Models:Category')->findBy([
        ...
        if(empty($this->category)) {
            ...
            $parent = !empty($this->parentId) ? $this->getEntityManager()->find('Models:Category', $this->parentId) : null;
