...
class AdditionProductImageForm extends Form {

    public $id = null;
    public $image;
    public $sort;

    /** @var AdditionProductImage|null */
    private $entity = null;
    ...
    /**
     * @param AdditionProductImage $entity
     */
    public function setEntity(AdditionProductImage $entity) {
        $this->entity = $entity;
