...
var SearchFormComponent = (function () {
    ...
    __decorate([
        core_1.Input(), 
        __metadata('design:type', search_form_1.SearchForm)
    ], SearchFormComponent.prototype, "form", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', orders_manager_1.OrdersManager)
    ], SearchFormComponent.prototype, "manager", void 0);
