...
@Component({
    selector: 'addition-categories-discount',
    templateUrl: './addition-categories-discount.html',
    styleUrls: ['./categories-discount.css'],
    encapsulation: ViewEncapsulation.None,
})
export class AdditionCategoriesDiscountComponent implements OnInit {
    ...
    public load(categories: AdditionCategory[]) {
        if(this.tree) {
            this.tree.destroy();
        }
        var $cont = $(this.eRef.nativeElement).find('.tree');
...
class TreeNode {
    ...
    public constructor(private category: AdditionCategory) {
        this.id = category.id;
